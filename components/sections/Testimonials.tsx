...
const testimonials = [
  {
    text: 'До работы с Данилом у нас была каша из заявок, чатов и ручных переносов. Он сначала разобрался в логике процессов, показал схему, а уже потом начал внедрение. В итоге заявки перестали теряться, а менеджеры наконец работают по понятным статусам.',
    author: 'Руководитель онлайн-проекта',
  },
  {
    text: 'Понравилось, что это не «настроил и пропал». Данил переработал чат-бота, убрал воду, добавил нормальную логику диалога и передачу контекста менеджеру. Бот стал реально помогать продажам, а не просто отвечать.',
  ...
  {
    text: 'Работаем с GetCourse, было много ручных действий и путаницы. Данил помог выстроить процессы и связать всё с CRM и уведомлениями. Стало спокойнее — система работает предсказуемо.',
